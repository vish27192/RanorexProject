...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("042e35c2-3bbd-40ad-a6cb-57f4cd75002c", ModuleType.Recording, 1)]
...
#region Variables
        ...
        /// </summary>
        [TestVariable("0fa4bebf-7fae-41d1-9a56-4cbe2cd9e11b")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text=$varTitle) on item 'ComAndroidKeepass.GroupActivity.DemoDrivenTitle'.", repo.ComAndroidKeepass.GroupActivity.DemoDrivenTitleInfo, new RecordItemIndex(0));
            Validate.AttributeEqual(repo.ComAndroidKeepass.GroupActivity.DemoDrivenTitleInfo, "Text", varTitle);
